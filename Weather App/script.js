const options = {
    method: 'GET',
    headers: {
        'x-rapidapi-key': '6f7c040a8fmshd90e8e81d1ceae0p17abd9jsn93f1a6d58790', // Your API Key
...
async function populateWeatherTable() {
    ...
    for (const row of rows) {
        ...
        // Wait for 1 second before making the next API call to avoid rate limit errors
        await delay(1000); 
